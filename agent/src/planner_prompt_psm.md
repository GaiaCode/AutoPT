# AutoPT Planner Prompt (aggiornato 2025-10-14 09:22:47)
...
- Esegui `extract_links` più spesso dopo un `crawl` per ampliare la coverage.
- Considera l'aggiunta di una fase di validazione automatica dei risultati.
